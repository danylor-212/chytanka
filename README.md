...
[Що всередині](#що-всередині) · [Екрани](#екрани) · [Цитати](#цитати-на-екрані-сну) · [Безкоштовні книжки](#безкоштовні-книжки) · [Встановлення](#встановлення) · [Збірка](#збірка-з-вихідного-коду) · [English](#english)
...
- **Прямо з читалки.** Каталог працює за стандартом OPDS: *Головна → Меню → Каталог OPDS → «Читанка — Книжки»*, вибираєте книжку, і вона завантажується по Wi‑Fi в бібліотеку. У наступному оновленні прошивки каталог уже вбудований; зараз його можна додати вручну за адресою нижче.
